      ...
      <div class="col-md-12">
        <form enctype="multipart/form-data" action="" method="post">
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="form-group">
                ...
                <input type="number" required  min="0" name="discount" class="form-control" placeholder="">
              </div>
              <div class="form-group">
                <label>Số lượng</label>
                <input type="number" required  min="0" name="quanlity" class="form-control" placeholder="">
              </div>
            </div>
            <div class="col">
                <div class="form-group">
          ...
          <div class="col-md-12 py-2 m-auto" style="text-align: center">
            <div class="form-group">
              <button type="submit" class= "rounded bg-success text-light px-3 py1">Thêm mới</button>
            </div>
          </div>
        </form>
      </div>
