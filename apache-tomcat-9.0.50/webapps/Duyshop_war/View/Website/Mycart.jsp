      ...
      <div class="col-md-4">
          <form method="post">
            <div class="mx-2 py-3 rounded" style="background-color: lavender">
              ...
              <div class="row mx-2">
                <label class="col">${customer.name}</label>
                <label class="col">${customer.phone}</label>
              </div>
              <p class="mx-4 mb-2">${customer.address}</p>
            </div>
            <div style="background-color: lavender" class="mx-2 my-3 py-3 rounded">
              <div class="mx-4 row">
                <label>Khuyến mại của Duyshop</label>
              </div>
              <div class="mx-4 row">
                <input class="col-md-7 form-control h-75" placeholder="Nhập mã khuyến mại">
                <button class="ml-3 col-md-4">áp dụng</button>
              </div>
            </div>
            <div style="background-color: lavender" class="mx-2 my-3 py-3 rounded">
              <div class="mx-4 row">
                <label class="col">Tạm tính</label>
              ...
              <div class="mx-4 row">
                <label class="col">Tổng cộng</label>
