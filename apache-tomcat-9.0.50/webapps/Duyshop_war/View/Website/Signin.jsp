...
<body id="bg">
<jsp:include page="/Component/Alert/errorAlert.jsp">
  <jsp:param name="messengeError" value="${messengeError}"/>
</jsp:include>
<!-- Boxed Layout -->
<div id="page" class="site boxed-layout">
  ...
  <div class="container py-5" style="text-align: center">
    ...
    <main class="w-25 m-auto my-3">
      <form method="post">
        <h1 class="h3 mb-3 fw-normal">Đăng nhập</h1>
        <div class="form-group">
          <label style="float: left">Email address</label>
          <input type="email" class="form-control" name="email" value="${bean.email}">
        </div>
        <div class="form-group">
          <label style="float: left">Password</label>
          <input type="password" class="form-control" value="${bean.password}" name="password" >
        </div>

        <div class="form-group mb-3">
          <label class="row px-3" style="float: left">
            <input style="width: 25px;margin-right: 10px" type="checkbox" value="${remember}" name="remember"> Remember me?
            <input style="width: 25px;margin-right: 10px;margin-left: 30px" type="checkbox" name="checkadmin"> Admin?
          </label>
        </div>
        ...
        <div class="checkbox mb-3 ">
          ...
          <label style="float: left">
            Chưa có tài khoản? <a style="color: red" href="<c:url value="/signup"/>">Đăng ký</a>
          </label>
          <label style="float: left">
            Quên mật khẩu? <a style="color: red" href="/signup">Đăng ký</a>
          </label>
        </div>
      </form>
    </main>
