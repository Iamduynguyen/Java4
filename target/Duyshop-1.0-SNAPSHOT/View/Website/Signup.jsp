...
<div id="page" class="site boxed-layout">
    ...
    <main class="w-25 m-auto my-3">
        <form method="post">
            <h1 class="h3 mb-3 fw-normal">Xin mời tạo mới</h1>
            <div class="form-group">
                <label style="float: left">Email</label>
                <input type="email" class="form-control" name="email" value="${bean.email}"required>
            </div>
            <div class="form-group">
                <label style="float: left">Họ tên</label>
                <input type="text" class="form-control" name="name" value="${bean.email}" required>
            </div>
            <div class="form-group">
                <label style="float: left">Password</label>
                <input type="password" class="form-control" value="${bean.password}" name="password" required>
            </div>

            <div class="form-group">
                <label style="float: left">Nhập lại Password</label>
                <input type="password" class="form-control" value="${bean.password}" name="repassword" required>
            </div>
            ...
            <div class="checkbox mb-3">
                <br>
                <label style="float: left">
                    Đã có tài khoản? <a style="color: red" href="<c:url value="/signin"/>">Đăng nhập</a>
                </label>
            </div>
        </form>
    </main>
