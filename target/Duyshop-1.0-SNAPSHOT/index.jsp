...
<div id="page" class="site boxed-layout">
    ...
    <%@include file="Component/Website/Banner.jsp"%>
    <%@include file="Component/Website/Suport.jsp"%>
    <%@include file="Component/Website/Aside1.jsp"%>
    <%@include file="Component/Website/Aside2.jsp"%>
